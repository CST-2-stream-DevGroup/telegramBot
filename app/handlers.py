...
async def cmd_start(message: Message):
    await message.answer_photo(
        ...
        caption='Привет! Я бот, созданный для помощи бездомным животным. '
                ...
                'нуждающихся в еде и заботе. Благодаря этому другие люди смогут прийти и покормить их или забрать к себе.\n\n'
                ...
                'Если возникнут проблемы при общении со мной, исопльзуйте комманду /support для получения помощи поддержки',
        reply_markup=kb.main)
